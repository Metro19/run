...
class TestPlanCommands(TestCase):
    ...
    VALID_PLAN_2 = Plan(ID="", name="", description="", date=dt, distance=2.223, distance_unit="inch", users="a#b#c")

    VALID_PLANS = [VALID_PLAN, VALID_PLAN_2]
    VALID_PLANS_USERS = [["x"], ["a", "b", "c"]]

    UPDATE_PLAN = Plan(ID="a", name="b", description="c", date=dt, distance=5, distance_unit="km", users="g")
